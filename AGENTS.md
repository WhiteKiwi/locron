...
Documentation is the source of truth for this repository. Always read `SPEC.md`, `IMPLEMENTATION.md`, and `TODO.md` before changing code. For a new or materially changed body of work, update the relevant planning document before implementation begins.

The required planning order is:

1. Draft or update `SPEC.md`.
2. Resolve its open questions through research and record supporting evidence in `FINDINGS.md` when research is needed.
3. Complete or update `IMPLEMENTATION.md`.
4. Complete or update `TODO.md`, including a verification method for every step in a plan with three or more steps.
...
### `IMPLEMENTATION.md` — How and Why This Approach
...
### `TODO.md` — Progress and Verification
...
- When specification questions remain, the research sub-session produces `FINDINGS.md` before the three planning documents are finalized.
