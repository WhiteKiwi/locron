...
grep -Fqx '      url "https://github.com/WhiteKiwi/locron/releases/download/v1.2.3/locron-v1.2.3-x86_64-apple-darwin.tar.gz"' "$formula"
grep -Fqx '      url "https://github.com/WhiteKiwi/locron/releases/download/v1.2.3/locron-v1.2.3-aarch64-unknown-linux-gnu.tar.gz"' "$formula"
grep -Fqx '      url "https://github.com/WhiteKiwi/locron/releases/download/v1.2.3/locron-v1.2.3-x86_64-unknown-linux-gnu.tar.gz"' "$formula"
